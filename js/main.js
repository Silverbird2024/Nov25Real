var NeoApp=angular.module("NeoApp",["ngAnimate","ngRoute","ngSanitize","ngTouch","ui.bootstrap"],function($interpolateProvider){$interpolateProvider.startSymbol("[");$interpolateProvider.endSymbol("]");});NeoApp.config(["$routeProvider",function($routeProvider,$scope,$rootScope){$routeProvider.when("/Home",{templateUrl:"Home",controller:"Home_Ctrl"});$routeProvider.when("/Timeline",{templateUrl:"Timeline",controller:"Timeline_Ctrl"});$routeProvider.when("/SWITCHES01",{templateUrl:"SWITCHES01",controller:"SWITCHES01_Ctrl"});$routeProvider.when("/ADHDhelper",{templateUrl:"ADHDhelper",controller:"ADHDhelper_Ctrl"});$routeProvider.when("/AppStatus",{templateUrl:"AppStatus",controller:"AppStatus_Ctrl"});$routeProvider.when("/Street100",{templateUrl:"Street100",controller:"Street100_Ctrl"});$routeProvider.when("/HelperTools",{templateUrl:"HelperTools",controller:"HelperTools_Ctrl"});$routeProvider.when("/HowToUse",{templateUrl:"HowToUse",controller:"HowToUse_Ctrl"});$routeProvider.when("/ADHD-Traits",{templateUrl:"ADHD-Traits",controller:"ADHD-Traits_Ctrl"});$routeProvider.when("/KnowThyself",{templateUrl:"KnowThyself",controller:"KnowThyself_Ctrl"});$routeProvider.when("/ADHDCharaters",{templateUrl:"ADHDCharaters",controller:"ADHDCharaters_Ctrl"});$routeProvider.when("/ADHDPuppetmasters",{templateUrl:"ADHDPuppetmasters",controller:"ADHDPuppetmasters_Ctrl"});$routeProvider.when("/Health",{templateUrl:"Health",controller:"Health_Ctrl"});$routeProvider.when("/Famous",{templateUrl:"Famous",controller:"Famous_Ctrl"});$routeProvider.when("/Famouslist",{templateUrl:"Famouslist",controller:"Famouslist_Ctrl"});$routeProvider.when("/Famouslist2",{templateUrl:"Famouslist2",controller:"Famouslist2_Ctrl"});$routeProvider.when("/Historical1a",{templateUrl:"Historical1a",controller:"Historical1a_Ctrl"});$routeProvider.when("/Historical1b",{templateUrl:"Historical1b",controller:"Historical1b_Ctrl"});$routeProvider.when("/Prayer",{templateUrl:"Prayer",controller:"Prayer_Ctrl"});$routeProvider.when("/EditionZero",{templateUrl:"EditionZero",controller:"EditionZero_Ctrl"});$routeProvider.when("/EditionZero001",{templateUrl:"EditionZero001",controller:"EditionZero001_Ctrl"});$routeProvider.when("/EditionZero002",{templateUrl:"EditionZero002",controller:"EditionZero002_Ctrl"});$routeProvider.when("/EZ001q",{templateUrl:"EZ001q",controller:"EZ001q_Ctrl"});$routeProvider.when("/EZ002q",{templateUrl:"EZ002q",controller:"EZ002q_Ctrl"});$routeProvider.when("/Edition001",{templateUrl:"Edition001",controller:"Edition001_Ctrl"});$routeProvider.when("/Edition002",{templateUrl:"Edition002",controller:"Edition002_Ctrl"});$routeProvider.when("/Edition003",{templateUrl:"Edition003",controller:"Edition003_Ctrl"});$routeProvider.when("/Edition004",{templateUrl:"Edition004",controller:"Edition004_Ctrl"});$routeProvider.when("/Tempversion1",{templateUrl:"Tempversion1",controller:"Tempversion1_Ctrl"});$routeProvider.when("/Edition005",{templateUrl:"Edition005",controller:"Edition005_Ctrl"});$routeProvider.when("/Diary",{templateUrl:"Diary",controller:"Diary_Ctrl"});$routeProvider.when("/Edition006",{templateUrl:"Edition006",controller:"Edition006_Ctrl"});$routeProvider.when("/Landingpage",{templateUrl:"Landingpage",controller:"Landingpage_Ctrl"});$routeProvider.otherwise({redirectTo:"/Home"});}]);NeoApp.filter("checkmark",function(){return function(input){return input?"\u2713":"\u2718";};});NeoApp.filter("element",function(){return function(input,idx1,idx2){idx1=idx1||0;if(input&&input.constructor===Array){if(idx2){return input[idx1,idx2];}else{return input[idx1];};};return"";};});NeoApp.filter("string",function(){return function(input){if(input&&input.constructor===Array)return input.toString();if(input)return input;return"";};});NeoApp.filter("default",function(){return function(input,defValue){if(!input)return defValue;return input;};});NeoApp.filter("trustUrl",function($sce){return function(url){return $sce.trustAsResourceUrl(url);};});NeoApp.filter('bool',function(){return function(input,valueTrue,valueFalse){return input!==true?valueFalse:valueTrue;};});NeoApp.filter('splitLt',function(){return function(str,delimeter){var p=str.indexOf(delimeter);return(p>-1)?str.substring(0,p):str;};});NeoApp.filter('splitRt',function(){return function(str,delimeter){var p=str.indexOf(delimeter);return(p>-1)?str.substring(p+1):str;};});NeoApp.controller("NeoApp_CoreCtrl",function($scope,$rootScope,$location,$route,$modal,$window,$timeout,$interval,$http,$filter,$compile,$animate){$App=$rootScope;$App.$on("$locationChangeStart",function(event,newUrl,oldUrl){var newPg=newUrl.substr(newUrl.lastIndexOf("/")+1);var oldPg=oldUrl.substr(oldUrl.lastIndexOf("/")+1);if(newPg=="!"){event.preventDefault();};if(newPg=="Home"){$timeout($scope.Home_pageenter);};if(oldPg=="Timeline"){$scope.Timeline_pageexit();};if(newPg=="Timeline"){$timeout($scope.Timeline_pageenter);};if(oldPg=="SWITCHES01"){$scope.SWITCHES01_pageexit();};if(oldPg=="Health"){$scope.Health_pageexit();};if(newPg=="Health"){$timeout($scope.Health_pageenter);};if(oldPg=="Famouslist"){$scope.Famouslist_pageexit();};if(newPg=="Famouslist"){$timeout($scope.Famouslist_pageenter);};if(oldPg=="Famouslist2"){$scope.Famouslist2_pageexit();};if(newPg=="Famouslist2"){$timeout($scope.Famouslist2_pageenter);};if(oldPg=="Historical1a"){$scope.Historical1a_pageexit();};if(newPg=="Historical1a"){$timeout($scope.Historical1a_pageenter);};if(oldPg=="Historical1b"){$scope.Historical1b_pageexit();};if(newPg=="Historical1b"){$timeout($scope.Historical1b_pageenter);};if(oldPg=="Diary"){$scope.Diary_pageexit();};if(newPg=="Diary"){$timeout($scope.Diary_pageenter);};});
...
$App.NAB={PageList:["Home","Timeline","SWITCHES01","ADHDhelper","AppStatus","Street100","HelperTools","HowToUse","ADHD-Traits","KnowThyself","ADHDCharaters","ADHDPuppetmasters","Health","Famous","Famouslist","Famouslist2","Historical1a","Historical1b","Prayer","EditionZero","EditionZero001","EditionZero002","EZ001q","EZ002q","Edition001","Edition002","Edition003","Edition004","Tempversion1","Edition005","Diary","Edition006","Landingpage"],PageEnterEffect:["","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""],PageCount:33,PageExitEffect:["","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""],PageNumber:1,AppScale:1,PageID:"",Hour:"",Hour24:"",Minute:"",Second:"",Time:"",Time24:"",DateShort:"",DateLong:"",DateFull:"",Month:"",MonthNum:"",WeekNum:"",Day:"",DayNum:"",Year:"",ClientWidth:$window.innerWidth,ClientHeight:$window.innerHeight,WindowWidth:$window.outerWidth,WindowHeight:$window.outerHeight,Orientation:$scope.GetOrientation(),OperatingSystem:"",$Watches:{},$Timers:{},$Audio:{}};$scope.__doUpdate=function(){var Now=new Date();$App.NAB.Hour=$filter("date")(Now,"h");$App.NAB.Hour24=$filter("date")(Now,"H");$App.NAB.Minute=$filter("date")(Now,"mm");$App.NAB.Second=$filter("date")(Now,"ss");$App.NAB.Time=$filter("date")(Now,"mediumTime");$App.NAB.Time24=$filter("date")(Now,"H:mm:ss");$App.NAB.DateShort=$filter("date")(Now,"shortDate");$App.NAB.DateLong=$filter("date")(Now,"longDate");$App.NAB.DateFull=$filter("date")(Now,"fullDate");$App.NAB.Month=$filter("date")(Now,"MMMM");$App.NAB.MonthNum=$filter("date")(Now,"M");$App.NAB.WeekNum=$filter("date")(Now,"w");$App.NAB.Day=$filter("date")(Now,"EEEE");$App.NAB.DayNum=$filter("date")(Now,"d");$App.NAB.Year=$filter("date")(Now,"yyyy");};$scope.__doOrientationChange=function(){$App.NAB.Orientation=$scope.GetOrientation();};$scope.__doResize=function(){$App.NAB.ClientWidth=$window.innerWidth;$App.NAB.ClientHeight=$window.innerHeight;$App.NAB.WindowWidth=$window.outerWidth;$App.NAB.WindowHeight=$window.outerHeight;};$scope.__init=function(){angular.element($window).bind("orientationchange.app",function(){$timeout($scope.__doOrientationChange);});angular.element($window).bind("resize.app",function(){$timeout($scope.__doResize);});$interval($scope.__doUpdate,1000);$App.NAB.OperatingSystem=GetPlatform();$scope.__doUpdate();};
$scope.Home_pageenter = function() {$App.quirk001 = "Procrastination";
$App.quirk002 = "Interuption";
$App.quirk003 = "Power-Words";
$App.quirk004 = "Prompts";
$App.quirk005 = "Forget Mid-Task";
$App.quirk006 = "Time Perception";
$App.quirk007 = "Out of sight";
$App.quirk008 = "Good days or bad days";
$App.quirk009 = "Over-impulsive";
$App.quirk010 = "Others’ eyes";
$App.quirk011 = "Decision fatigue ";
$App.quirk012 = "Motivation is complex";
$App.quirk013 = "Overstimulated ";
$App.quirk014 = "Pendulum ";
$App.quirk015 = "Anxiety";
$App.quirk016 = "Future Me";
$App.quirk017 = "Mental load";
$App.quirk018 = "Systems";
$App.quirk019 = "Preparation time";
$App.quirk020 = "Focus during Stress";
$App.quirk021 = "Doom-piles";
$App.quirk022 = "Social burnout";
$App.quirk023 = "Winging it";
$App.quirk024 = "Mood changes";
$App.quirk025 = "Doom Scroll";
$App.quirk001a = "We procrastinate";
$App.quirk002a = "We Interupt";
$App.quirk003a = "We Use Power Words";
$App.quirk004a = "We need Prompts";
$App.quirk005a = "We Forget mid task";
$App.quirk006a = "We struggle with Time";
$App.quirk007a = "Out of Mind";
$App.quirk008a = "Its black or white";
$App.quirk009a = "Out of Mind";
$App.quirk010a = "Its black or white";
$App.level = localStorage.getItem("level");
$scope.HideObject("Line1","",0);
$scope.HideObject("Line2","",0);
$scope.HideObject("Line3","",0);
$scope.HideObject("Line4","",0);
$scope.HideObject("Line5","",0);
$scope.HideObject("Line6","",0);
$scope.HideObject("Line7","",0);
$scope.HideObject("Line8","",0);
$scope.HideObject("Line9","",0);
$scope.HideObject("Line10","",0);
$scope.HideObject("Line11","",0);
$scope.HideObject("Line12","",0);
$App.switch001 = localStorage.getItem("switch001");
$App.switch001a = localStorage.getItem("switch001a");
$App.switch002 = localStorage.getItem("switch002");
$App.switch002a = localStorage.getItem("switch002a");
$App.switch003 = localStorage.getItem("switch003");
$App.switch003a = localStorage.getItem("switch003a");
$App.switch004 = localStorage.getItem("switch004");
$App.switch004a = localStorage.getItem("switch004a");
$App.switch005 = localStorage.getItem("switch005");
$App.switch005a = localStorage.getItem("switch005a");
$App.switch006 = localStorage.getItem("switch006");
$App.switch006a = localStorage.getItem("switch006a");
$App.switch007 = localStorage.getItem("switch007");
$App.switch007a = localStorage.getItem("switch007a");
$App.switch008 = localStorage.getItem("switch008");
$App.switch008a = localStorage.getItem("switch008a");
$App.switch009 = localStorage.getItem("switch009");
$App.switch009a = localStorage.getItem("switch009a");
$App.switch010 = localStorage.getItem("switch010");
$App.switch010a = localStorage.getItem("switch010a");
...
$scope.Timeline_pageenter = function() {$App.date01 = localStorage.getItem("date01");
$App.date02 = localStorage.getItem("date02");
$App.date03 = localStorage.getItem("date03");
$App.date04 = localStorage.getItem("date04");
$App.date05 = localStorage.getItem("date05");
$App.date01a = localStorage.getItem("date01a");
$App.date02a = localStorage.getItem("date02a");
$App.date03a = localStorage.getItem("date03a");
$App.date04a = localStorage.getItem("date04a");
$App.date05a = localStorage.getItem("date05a");
$App.date06 = localStorage.getItem("date06");
$App.date07 = localStorage.getItem("date07");
$App.date08 = localStorage.getItem("date08");
$App.date09 = localStorage.getItem("date09");
$App.date10 = localStorage.getItem("date10");
$App.date11 = localStorage.getItem("date11");
$App.date12 = localStorage.getItem("date12");
$App.date06a = localStorage.getItem("date06a");
$App.date07a = localStorage.getItem("date07a");
$App.date08a = localStorage.getItem("date08a");
$App.date09a = localStorage.getItem("date09a");
$App.date10a = localStorage.getItem("date10a");
$App.date11a = localStorage.getItem("date11a");
$App.date12a = localStorage.getItem("date12a");
$App.timenotes = localStorage.getItem("timenotes");};
$scope.Timeline_pageexit = function() {localStorage.setItem("date01",$App.date01);
localStorage.setItem("date02",$App.date02);
localStorage.setItem("date03",$App.date03);
localStorage.setItem("date04",$App.date04);
localStorage.setItem("date05",$App.date05);
localStorage.setItem("date01a",$App.date01a);
localStorage.setItem("date02a",$App.date02a);
localStorage.setItem("date03a",$App.date03a);
localStorage.setItem("date04a",$App.date04a);
localStorage.setItem("date05a",$App.date05a);
localStorage.setItem("date06",$App.date06);
localStorage.setItem("date07",$App.date07);
localStorage.setItem("date08",$App.date08);
localStorage.setItem("date09",$App.date09);
localStorage.setItem("date10",$App.date10);
localStorage.setItem("date11",$App.date11);
localStorage.setItem("date12",$App.date12);
localStorage.setItem("date06a",$App.date06a);
localStorage.setItem("date07a",$App.date07a);
localStorage.setItem("date08a",$App.date08a);
localStorage.setItem("date09a",$App.date09a);
localStorage.setItem("date10a",$App.date10a);
localStorage.setItem("date09a",$App.date09a);
localStorage.setItem("date10a",$App.date10a);
localStorage.setItem("date11a",$App.date11a);
localStorage.setItem("date12a",$App.date12a);
localStorage.setItem("timenotes",$App.timenotes);};
...
localStorage.setItem("switch002a",$App.switch002a);
localStorage.setItem("Comp001",$App.Comp001);
localStorage.setItem("Comp002",$App.Comp002);};
$scope.Health_pageenter = function() {$App.gender = localStorage.getItem("gender");
...
$App.Lua = localStorage.getItem("Lua");
$App.Rua = localStorage.getItem("Rua");
$App.lfa = localStorage.getItem("lfa");
$App.rfa = localStorage.getItem("rfa");
$App.lwrist = localStorage.getItem("lwrist");
$App.rwrist = localStorage.getItem("rwrist");
$App.Chest = localStorage.getItem("Chest");
$App.Tummy = localStorage.getItem("Tummy");
$App.lwrist = localStorage.getItem("lwrist");
$App.rwrist = localStorage.getItem("rwrist");
$App.URL = localStorage.getItem("URL");
$App.ULL = localStorage.getItem("ULL");
$App.LRL = localStorage.getItem("LRL");
$App.LLL = localStorage.getItem("LLL");};
$scope.Health_pageexit = function() {localStorage.setItem("gender",$App.gender);
localStorage.setItem("age",$App.age);
localStorage.setItem("weight",$App.weight);
localStorage.setItem("Tummy",$App.Tummy);
localStorage.setItem("Chest",$App.Chest);
localStorage.setItem("Lua",$App.Lua);
localStorage.setItem("Rua",$App.Rua);
localStorage.setItem("lfa",$App.lfa);
localStorage.setItem("rfa",$App.rfa);
localStorage.setItem("lwrist",$App.lwrist);
localStorage.setItem("rwrist",$App.rwrist);
localStorage.setItem("Chest",$App.Chest);
localStorage.setItem("Tummy",$App.Tummy);
localStorage.setItem("lwrist",$App.lwrist);
localStorage.setItem("rwrist",$App.rwrist);
localStorage.setItem("URL",$App.URL);
localStorage.setItem("ULL",$App.ULL);
localStorage.setItem("LRL",$App.LRL);
localStorage.setItem("LLL",$App.LLL);};
$scope.Famouslist_pageenter = function() {$App.fam1 = localStorage.getItem("fam1");
$App.fam1d = localStorage.getItem("fam1d");
$App.fam2 = localStorage.getItem("fam2");
$App.fam2d = localStorage.getItem("fam2d");
$App.fam3 = localStorage.getItem("fam3");
$App.fam3d = localStorage.getItem("fam3d");
$App.fam4 = localStorage.getItem("fam4");
$App.fam4d = localStorage.getItem("fam4d");};
$scope.Famouslist_pageexit = function() {localStorage.setItem("fam1",$App.fam1);
localStorage.setItem("fam1d",$App.fam1d);
localStorage.setItem("fam2",$App.fam2);
localStorage.setItem("fam2d",$App.fam2d);
localStorage.setItem("fam3",$App.fam3);
localStorage.setItem("fam3d",$App.fam3d);
localStorage.setItem("fam4",$App.fam4);
localStorage.setItem("fam4d",$App.fam4d);};
$scope.Famouslist2_pageenter = function() {$App.fam5 = localStorage.getItem("fam5");
$App.fam5d = localStorage.getItem("fam5d");
$App.fam6 = localStorage.getItem("fam6");
$App.fam6d = localStorage.getItem("fam6d");
$App.fam7 = localStorage.getItem("fam7");
$App.fam7d = localStorage.getItem("fam7d");
$App.fam8 = localStorage.getItem("fam8");
$App.fam8d = localStorage.getItem("fam8d");};
$scope.Famouslist2_pageexit = function() {localStorage.setItem("fam5",$App.fam5);
localStorage.setItem("fam5d",$App.fam5d);
localStorage.setItem("fam6",$App.fam6);
localStorage.setItem("fam6d",$App.fam6d);
localStorage.setItem("fam7",$App.fam7);
localStorage.setItem("fam7d",$App.fam7d);
localStorage.setItem("fam8",$App.fam8);
localStorage.setItem("fam8d",$App.fam8d);};
$scope.Historical1a_pageenter = function() {$App.fam1 = localStorage.getItem("fam1");
$App.fam1d = localStorage.getItem("fam1d");
$App.fam2 = localStorage.getItem("fam2");
$App.fam2d = localStorage.getItem("fam2d");
$App.fam3 = localStorage.getItem("fam3");
...
$App.fam4 = localStorage.getItem("fam4");
$App.fam4d = localStorage.getItem("fam4d");};
$scope.Historical1a_pageexit = function() {localStorage.setItem("fam1",$App.fam1);
localStorage.setItem("fam1d",$App.fam1d);
localStorage.setItem("fam2",$App.fam2);
localStorage.setItem("fam2d",$App.fam2d);
localStorage.setItem("fam3",$App.fam3);
...
localStorage.setItem("fam4",$App.fam4);
localStorage.setItem("fam4d",$App.fam4d);};
$scope.Historical1b_pageenter = function() {$App.fam1 = localStorage.getItem("fam1");
$App.fam1d = localStorage.getItem("fam1d");
$App.fam2 = localStorage.getItem("fam2");
$App.fam2d = localStorage.getItem("fam2d");
$App.fam3 = localStorage.getItem("fam3");
...
$App.fam4 = localStorage.getItem("fam4");
$App.fam4d = localStorage.getItem("fam4d");};
$scope.Historical1b_pageexit = function() {localStorage.setItem("fam1",$App.fam1);
localStorage.setItem("fam1d",$App.fam1d);
localStorage.setItem("fam2",$App.fam2);
localStorage.setItem("fam2d",$App.fam2d);
localStorage.setItem("fam3",$App.fam3);
...
localStorage.setItem("fam4",$App.fam4);
localStorage.setItem("fam4d",$App.fam4d);};
$scope.Diary_pageenter = function() {$App.diary = localStorage.getItem("diary");};
$scope.Diary_pageexit = function() {localStorage.setItem("diary",$App.diary);};
$App.switch001a=0;
$App.switch001=1;
$App.switch002a=0;
$App.switch002=1;
...
$App.NAB.PageID = "Home";
$scope.PushButton13_click = function() {$scope.GotoPage( "ADHDhelper" );};
$scope.PushButton14_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton15_click = function() {$scope.GotoPage( "Timeline" );};
...
$scope.PushButton42_click = function() {$App.Prayer = localStorage.getItem("Prayer");
$scope.GotoPage( "Prayer" );};
$scope.PushButton86_click = function() {$App.switch001 = 50;
$scope.GotoPage( "SWITCHES01" );};
$scope.Headline189_click = function() {$scope.GotoPage( "Tempversion1" );};
$scope.PushButton101_click = function() {$scope.GotoPage( "Landingpage" );};
$scope.Headline204_click = function() {$scope.GotoPage( "Tempversion1" );};
$scope.Headline42_click = function() {$scope.GotoPage( "Tempversion1" );};
});
...
$scope.Headline6_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton104_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton109_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton110_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton112_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton113_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton114_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton115_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton116_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton117_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton118_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton102_click = function() {$scope.GotoPage( "Timeline" );};
$scope.PushButton119_click = function() {$scope.GotoPage( "Timeline" );};
});
...
$App.Comp002 = localStorage.getItem("Comp002");
$App.Comptot = $scope.Calculate($App.Comp001+"+"+$App.Comp002+"+"+$App.Comp003+"+"+$App.Comp004+"+"+$App.Comp005+"+"+$App.Comp006+"+"+$App.Comp007+"+"+$App.Comp008,-1);};
$scope.Headline313_click = function() {$scope.GotoPage( "Tempversion1" );};
});
...
$scope.Headline201_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("AppStatus_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 5;
$App.NAB.PageID = "AppStatus";
$scope.Headline17_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton4_click = function() {$scope.GotoPage( "Edition001" );};
$scope.PushButton1_click = function() {$scope.GotoPage( "Edition002" );};
$scope.PushButton2_click = function() {$scope.GotoPage( "Edition003" );};
$scope.PushButton49_click = function() {$scope.GotoPage( "Edition004" );};
$scope.PushButton50_click = function() {$scope.GotoPage( "Edition005" );};
$scope.PushButton51_click = function() {$scope.GotoPage( "Edition006" );};
$scope.Headline11_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton47_click = function() {$App.level = localStorage.getItem("level");
$App.level = $scope.Calculate($App.level+"+1",-1);
localStorage.setItem("level",$App.level);
if ($App.level >= "1") {
$scope.ShowObject("Line1","",0);
} else {
};
if ($App.level >= "2") {
$scope.ShowObject("Line1","",0);
$scope.ShowObject("Line2","",0);
} else {
};
if ($App.level >= "3") {
$scope.ShowObject("Line1","",0);
$scope.ShowObject("Line2","",0);
$scope.ShowObject("Line3","",0);
} else {
};
if ($App.level >= "4") {
$scope.ShowObject("Line1","",0);
...
$scope.ShowObject("Line10","",0);
$scope.ShowObject("Line11","",0);
$scope.ShowObject("Line12","",0);
} else {
};};
$scope.PushButton48_click = function() {$App.level = localStorage.getItem("level");
$App.level = $scope.Calculate($App.level+"-1",-1);
localStorage.setItem("level",$App.level);
$scope.HideObject("Line1","",0);
$scope.HideObject("Line2","",0);
...
$scope.PushButton81_click = function() {$scope.GotoPage( "EditionZero001" );};
});
NeoApp.controller("Street100_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 6;
$App.NAB.PageID = "Street100";
$scope.Headline193_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("HelperTools_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 7;
$App.NAB.PageID = "HelperTools";
$scope.Headline9_click = function() {$scope.GotoPage( "A-Z" );};
$scope.Headline10_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline34_click = function() {$scope.GotoPage( "A-Z" );};
$scope.Headline35_click = function() {$scope.GotoPage( "Home" );};
$scope.Headline56_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("ADHD-Traits_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 9;
$App.NAB.PageID = "ADHD-Traits";
$scope.Headline57_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline58_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("ADHDCharaters_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 11;
$App.NAB.PageID = "ADHDCharaters";
$scope.Headline25_click = function() {$scope.GotoPage( "A-Z" );};
$scope.Headline26_click = function() {$scope.GotoPage( "Home" );};
$scope.Headline59_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("ADHDPuppetmasters_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 12;
$App.NAB.PageID = "ADHDPuppetmasters";
$scope.Headline30_click = function() {$scope.GotoPage( "A-Z" );};
$scope.Headline31_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline62_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton120_click = function() {$scope.GotoPage( "Famouslist" );};
});
NeoApp.controller("Famouslist_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 15;
$App.NAB.PageID = "Famouslist";
$scope.Headline218_click = function() {$scope.GotoPage( "Home" );};
$scope.Pager2_prevclick = function() {$scope.GotoPrevPage();};
$scope.Pager2_nextclick = function() {$scope.GotoNextPage();};
});
NeoApp.controller("Famouslist2_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 16;
$App.NAB.PageID = "Famouslist2";
...
NeoApp.controller("Historical1a_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 17;
$App.NAB.PageID = "Historical1a";
$scope.Headline242_click = function() {$scope.GotoPage( "Home" );};
$scope.Pager4_prevclick = function() {$scope.GotoPrevPage();};
$scope.Pager4_nextclick = function() {$scope.GotoNextPage();};
});
NeoApp.controller("Historical1b_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 18;
$App.NAB.PageID = "Historical1b";
$scope.Headline240_click = function() {$scope.GotoPage( "Home" );};
...
$scope.Headline64_click = function() {$scope.GotoPage( "A-Z" );};
$scope.Headline66_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea1_change = function() {localStorage.setItem("Prayer",$App.Prayer);};
$scope.PushButton43_click = function() {neoTalkSpeak($App.Prayer, "", 1, 1);};
$scope.PushButton44_click = function() {neoTalkCancelSpeech();};
$scope.PushButton45_click = function() {neoTalkPauseSpeech();};
});
NeoApp.controller("EditionZero_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 20;
$App.NAB.PageID = "EditionZero";
$scope.Headline50_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton56_click = function() {$scope.GotoPage( "EditionZero001" );};
$scope.PushButton57_click = function() {$scope.GotoPage( "ADHD-Traits" );};
$scope.PushButton58_click = function() {$scope.GotoPage( "ADHD-Traits" );};
$scope.PushButton59_click = function() {$scope.GotoPage( "ADHD-Traits" );};
$scope.PushButton60_click = function() {$scope.GotoPage( "EditionZero002" );};
$scope.PushButton61_click = function() {$scope.GotoPage( "ADHD-Traits" );};
$scope.PushButton62_click = function() {$scope.GotoPage( "ADHD-Traits" );};
$scope.PushButton63_click = function() {$scope.GotoPage( "ADHD-Traits" );};
$scope.PushButton64_click = function() {$scope.GotoPage( "ADHD-Traits" );};
$scope.PushButton65_click = function() {$scope.GotoPage( "ADHD-Traits" );};
});
NeoApp.controller("EditionZero001_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 21;
$App.NAB.PageID = "EditionZero001";
$scope.Headline152_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton68_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton69_click = function() {$scope.GotoPage( "EZ001q" );};
});
NeoApp.controller("EditionZero002_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 22;
$App.NAB.PageID = "EditionZero002";
$scope.Headline154_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton74_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton73_click = function() {$scope.GotoPage( "ADHD-Traits" );};
$scope.PushButton75_click = function() {$scope.GotoPage( "EZ002q" );};
});
NeoApp.controller("EZ001q_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 23;
$App.NAB.PageID = "EZ001q";
$scope.PushButton77_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton78_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton79_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton80_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.Headline160_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton70_click = function() {$scope.GotoPage( "EditionZero" );};
});
NeoApp.controller("EZ002q_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 24;
$App.NAB.PageID = "EZ002q";
$scope.Headline165_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton88_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton84_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton89_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton90_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton91_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton92_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton85_click = function() {$scope.GotoPage( "EditionZero" );};
$scope.PushButton93_click = function() {$scope.GotoPage( "EditionZero" );};
});
NeoApp.controller("Edition001_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 25;
$App.NAB.PageID = "Edition001";
$scope.Headline53_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("Edition002_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 26;
$App.NAB.PageID = "Edition002";
$scope.Headline52_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("Edition003_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 27;
$App.NAB.PageID = "Edition003";
$scope.Headline65_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("Edition004_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 28;
$App.NAB.PageID = "Edition004";
$scope.Headline114_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("Tempversion1_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 29;
$App.NAB.PageID = "Tempversion1";
$scope.PushButton111_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("Edition005_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 30;
$App.NAB.PageID = "Edition005";
$scope.Headline126_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline61_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("Edition006_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 32;
$App.NAB.PageID = "Edition006";
$scope.Headline138_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline203_click = function() {$scope.GotoPage( "Home" );};
});
