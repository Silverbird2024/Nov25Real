...
$scope.Headline20_click = function() {$scope.GotoPage( "A-Z" );};
$scope.Headline21_click = function() {$scope.GotoPage( "Home" );};
...
$scope.Headline41_click = function() {$scope.GotoPage( "A-Z" );};
$scope.Headline42_click = function() {$scope.GotoPage( "Home" );};
