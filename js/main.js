...
$scope.J4ME001_pageenter = function() {$App.j4m001 = localStorage.getItem("jfm001");};
$scope.J4ME001mf_pageenter = function() {$App.j4m001mf = localStorage.getItem("jfm001mf");};
$scope.J4ME002mf_pageenter = function() {$App.j4m002mf = localStorage.getItem("jfm002mf");};
$scope.J4ME003mf_pageenter = function() {$App.j4m003mf = localStorage.getItem("jfm003mf");};
$scope.J4ME002_pageenter = function() {$App.j4m001 = localStorage.getItem("jfm001");
$App.qj4m001a = localStorage.getItem("qjfm001a");
$App.qj4m001b = localStorage.getItem("qjfm001b");
$App.qj4m002a = localStorage.getItem("qjfm002a");
$App.qj4m002b = localStorage.getItem("qjfm002b");
$App.qj4m003a = localStorage.getItem("qjfm003a");
$App.qj4m003b = localStorage.getItem("qjfm003b");
$App.qj4m004a = localStorage.getItem("qjfm004a");
$App.qj4m004b = localStorage.getItem("qjfm004b");};
$scope.J4ME003_pageenter = function() {$App.j4m001 = localStorage.getItem("jfm001");
$App.qj4m005a = localStorage.getItem("qjfm005a");
$App.qj4m005b = localStorage.getItem("qjfm005b");
$App.qj4m006a = localStorage.getItem("qjfm006a");
$App.qj4m006b = localStorage.getItem("qjfm006b");
$App.qj4m007a = localStorage.getItem("qjfm007a");
$App.qj4m007b = localStorage.getItem("qjfm007b");
$App.qj4m008a = localStorage.getItem("qjfm008a");
$App.qj4m008b = localStorage.getItem("qjfm008b");};
$scope.J4ME004_pageenter = function() {$App.j4m001 = localStorage.getItem("jfm001");
$App.qj4m009a = localStorage.getItem("qjfm009a");
$App.qj4m009b = localStorage.getItem("qjfm009b");
$App.qj4m010a = localStorage.getItem("qjfm010a");
$App.qj4m010b = localStorage.getItem("qjfm010b");
$App.qj4m011a = localStorage.getItem("qjfm011a");
$App.qj4m011b = localStorage.getItem("qjfm011b");
$App.qj4m012a = localStorage.getItem("qjfm012a");
$App.qj4m012b = localStorage.getItem("qjfm012b");};
...
localStorage.setItem("neck",$App.neck);
...
$scope.Nutrientsandvitamins_pageenter = function() {$App.gender = localStorage.getItem("gender");
$App.age = localStorage.getItem("age");
$App.weight = localStorage.getItem("weight");
$App.neck = localStorage.getItem("neck");
$App.Tummy = localStorage.getItem("Tummy");
...
$App.LRL = localStorage.getItem("LRL");
$App.LLL = localStorage.getItem("LLL");};
$scope.Nutrientsandvitamins_pageexit = function() {localStorage.setItem("gender",$App.gender);
localStorage.setItem("age",$App.age);
localStorage.setItem("weight",$App.weight);
localStorage.setItem("neck",$App.neck);
localStorage.setItem("Tummy",$App.Tummy);
...
localStorage.setItem("LRL",$App.LRL);
localStorage.setItem("LLL",$App.LLL);};
$scope.ADHDfood_pageenter = function() {$App.gender = localStorage.getItem("gender");
$App.age = localStorage.getItem("age");
$App.weight = localStorage.getItem("weight");
$App.neck = localStorage.getItem("neck");
$App.Tummy = localStorage.getItem("Tummy");
...
$App.LRL = localStorage.getItem("LRL");
$App.LLL = localStorage.getItem("LLL");};
$scope.ADHDfood_pageexit = function() {localStorage.setItem("gender",$App.gender);
localStorage.setItem("age",$App.age);
localStorage.setItem("weight",$App.weight);
localStorage.setItem("neck",$App.neck);
localStorage.setItem("Tummy",$App.Tummy);
...
localStorage.setItem("LRL",$App.LRL);
localStorage.setItem("LLL",$App.LLL);};
$scope.Statsimage_pageenter = function() {$App.gender = localStorage.getItem("gender");
$App.age = localStorage.getItem("age");
$App.weight = localStorage.getItem("weight");
$App.neck = localStorage.getItem("neck");
$App.Tummy = localStorage.getItem("Tummy");
...
$App.LRL = localStorage.getItem("LRL");
$App.LLL = localStorage.getItem("LLL");};
$scope.Statsimage_pageexit = function() {localStorage.setItem("gender",$App.gender);
localStorage.setItem("age",$App.age);
localStorage.setItem("weight",$App.weight);
localStorage.setItem("neck",$App.neck);
localStorage.setItem("Tummy",$App.Tummy);
...
$scope.PushButton129_click = function() {$scope.GotoPage( "J4ME001" );};
$scope.Headline292_click = function() {$scope.GotoPage( "Tempversion1" );};
});
...
NeoApp.controller("J4ME001_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 5;
$App.NAB.PageID = "J4ME001";
$scope.Headline291_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea20_change = function() {localStorage.setItem("jfm001",$App.j4m001);};
$scope.PushButton131_click = function() {$scope.GotoPage( "J4ME002" );};
$scope.PushButton132_click = function() {$scope.GotoPage( "J4ME001" );};
$scope.Headline293_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton142_click = function() {$scope.GotoPage( "J4ME001mf" );};
});
NeoApp.controller("J4ME001mf_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 6;
$App.NAB.PageID = "J4ME001mf";
$scope.Headline304_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea48_change = function() {localStorage.setItem("jfm001",$App.j4m001);};
$scope.PushButton144_click = function() {$scope.GotoPage( "J4ME002" );};
$scope.PushButton145_click = function() {$scope.GotoPage( "J4ME001" );};
$scope.Headline305_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton146_click = function() {$scope.GotoPage( "J4ME001mf" );};
$scope.Headline306_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea49_change = function() {localStorage.setItem("jfm001mf",$App.j4m001mf);};
$scope.TextArea52_change = function() {localStorage.setItem("jfm001mf",$App.j4m001mf);};
$scope.Pager9_prevclick = function() {$scope.GotoPrevPage();};
$scope.Pager9_nextclick = function() {$scope.GotoNextPage();};
});
NeoApp.controller("J4ME002mf_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 7;
$App.NAB.PageID = "J4ME002mf";
$scope.Headline308_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea50_change = function() {localStorage.setItem("jfm001",$App.j4m001);};
$scope.PushButton148_click = function() {$scope.GotoPage( "J4ME002" );};
$scope.PushButton149_click = function() {$scope.GotoPage( "J4ME001" );};
$scope.Headline309_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton150_click = function() {$scope.GotoPage( "J4ME001mf" );};
$scope.Headline310_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea51_change = function() {localStorage.setItem("jfm002mf",$App.j4m002mf);};
$scope.Pager10_prevclick = function() {$scope.GotoPrevPage();};
$scope.Pager10_nextclick = function() {$scope.GotoNextPage();};
});
NeoApp.controller("J4ME003mf_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 8;
$App.NAB.PageID = "J4ME003mf";
$scope.Headline312_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea53_change = function() {localStorage.setItem("jfm001",$App.j4m001);};
$scope.PushButton152_click = function() {$scope.GotoPage( "J4ME002" );};
$scope.PushButton153_click = function() {$scope.GotoPage( "J4ME001" );};
$scope.Headline314_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton154_click = function() {$scope.GotoPage( "J4ME001mf" );};
$scope.Headline315_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea54_change = function() {localStorage.setItem("jfm003mf",$App.j4m003mf);};
$scope.Pager11_prevclick = function() {$scope.GotoPrevPage();};
$scope.Pager11_nextclick = function() {$scope.GotoNextPage();};
});
NeoApp.controller("J4ME002_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 9;
$App.NAB.PageID = "J4ME002";
$scope.Headline295_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea21_change = function() {localStorage.setItem("qjfm001a",$App.qj4m001a);};
$scope.PushButton135_click = function() {$scope.GotoPage( "J4ME001" );};
$scope.Headline296_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea22_change = function() {localStorage.setItem("qjfm001b",$App.qj4m001b);};
$scope.TextArea23_change = function() {localStorage.setItem("qjfm002a",$App.qj4m002a);};
$scope.TextArea24_change = function() {localStorage.setItem("qjfm002b",$App.qj4m002b);};
$scope.TextArea25_change = function() {localStorage.setItem("qjfm003a",$App.qj4m003a);};
$scope.TextArea26_change = function() {localStorage.setItem("qjfm003b",$App.qj4m003b);};
$scope.TextArea27_change = function() {localStorage.setItem("qjfm004a",$App.qj4m004a);};
$scope.TextArea28_change = function() {localStorage.setItem("qjfm004b",$App.qj4m004b);};
$scope.TextArea29_change = function() {localStorage.setItem("jfm001",$App.j4m001);};
$scope.Pager7_prevclick = function() {$scope.GotoPrevPage();};
$scope.Pager7_nextclick = function() {$scope.GotoNextPage();};
});
NeoApp.controller("J4ME003_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 10;
$App.NAB.PageID = "J4ME003";
$scope.Headline298_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea30_change = function() {localStorage.setItem("qjfm005a",$App.qj4m005a);};
$scope.PushButton138_click = function() {$scope.GotoPage( "J4ME001" );};
$scope.Headline299_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea31_change = function() {localStorage.setItem("qjfm005b",$App.qj4m005b);};
$scope.TextArea32_change = function() {localStorage.setItem("qjfm006a",$App.qj4m006a);};
$scope.TextArea33_change = function() {localStorage.setItem("qjfm006b",$App.qj4m006b);};
$scope.TextArea34_change = function() {localStorage.setItem("qjfm007a",$App.qj4m007a);};
$scope.TextArea35_change = function() {localStorage.setItem("qjfm007b",$App.qj4m007b);};
$scope.TextArea36_change = function() {localStorage.setItem("qjfm008a",$App.qj4m008a);};
$scope.TextArea37_change = function() {localStorage.setItem("qjfm008b",$App.qj4m008b);};
$scope.TextArea38_change = function() {localStorage.setItem("jfm001",$App.j4m001);};
$scope.Pager6_prevclick = function() {$scope.GotoPrevPage();};
$scope.Pager6_nextclick = function() {$scope.GotoNextPage();};
});
NeoApp.controller("J4ME004_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 11;
$App.NAB.PageID = "J4ME004";
$scope.Headline301_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea39_change = function() {localStorage.setItem("qjfm009a",$App.qj4m009a);};
$scope.PushButton141_click = function() {$scope.GotoPage( "J4ME001" );};
$scope.Headline302_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea40_change = function() {localStorage.setItem("qjfm009b",$App.qj4m009b);};
$scope.TextArea41_change = function() {localStorage.setItem("qjfm010a",$App.qj4m010a);};
$scope.TextArea42_change = function() {localStorage.setItem("qjfm010b",$App.qj4m010b);};
$scope.TextArea43_change = function() {localStorage.setItem("qjfm011a",$App.qj4m011a);};
$scope.TextArea44_change = function() {localStorage.setItem("qjfm011b",$App.qj4m011b);};
$scope.TextArea45_change = function() {localStorage.setItem("qjfm012a",$App.qj4m012a);};
$scope.TextArea46_change = function() {localStorage.setItem("qjfm012b",$App.qj4m012b);};
$scope.TextArea47_change = function() {localStorage.setItem("jfm001",$App.j4m001);};
...
$scope.PushButton98_click = function() {$scope.GotoPage( "Statsimage" );};
$scope.PushButton99_click = function() {$scope.GotoPage( "Statsimage" );};
$scope.PushButton125_click = function() {$scope.GotoPage( "ADHDfood" );};
});
NeoApp.controller("Nutrientsandvitamins_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 21;
$App.NAB.PageID = "Nutrientsandvitamins";
$scope.Headline287_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton106_click = function() {$scope.GotoPage( "Statsimage" );};
$scope.PushButton126_click = function() {$scope.GotoPage( "Health" );};
});
NeoApp.controller("ADHDfood_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 22;
$App.NAB.PageID = "ADHDfood";
$scope.Headline289_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton108_click = function() {$scope.GotoPage( "Statsimage" );};
$scope.PushButton127_click = function() {$scope.GotoPage( "Health" );};
});
NeoApp.controller("Statsimage_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 23;
$App.NAB.PageID = "Statsimage";
$scope.Headline60_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton128_click = function() {$scope.GotoPage( "Health" );};
});
