...
$scope.SWITCHES02_pageexit = function() {localStorage.setItem("switch003",$App.switch003);
localStorage.setItem("switch003a",$App.switch003a);
localStorage.setItem("switch004",$App.switch004);
localStorage.setItem("switch004a",$App.switch004a);
localStorage.setItem("Comp003",$App.Comp003);
localStorage.setItem("Comp004",$App.Comp004);};
$scope.SWITCHES03_pageexit = function() {localStorage.setItem("switch005",$App.switch005);
localStorage.setItem("switch005a",$App.switch005a);
localStorage.setItem("switch006",$App.switch006);
localStorage.setItem("switch006a",$App.switch006a);
localStorage.setItem("Comp005",$App.Comp005);
localStorage.setItem("Comp006",$App.Comp006);};
$scope.SWITCHES04_pageexit = function() {localStorage.setItem("switch007",$App.switch007);
localStorage.setItem("switch007a",$App.switch007a);
localStorage.setItem("switch008",$App.switch008);
localStorage.setItem("switch008a",$App.switch008a);
localStorage.setItem("Comp007",$App.Comp007);
localStorage.setItem("Comp008",$App.Comp008);};
$scope.SWITCHES05_pageexit = function() {localStorage.setItem("switch009",$App.switch009);
localStorage.setItem("switch009a",$App.switch009a);
localStorage.setItem("switch010",$App.switch010);
...
$App.NAB.PageID = "SWITCHES02";
$scope.Headline200_click = function() {$scope.GotoPage( "Home" );};
$scope.Slider5_change = function() {$App.Comp003 = $scope.Calculate($App.switch003+"-"+$App.switch003a,-1);
if ($App.Comp003 <= "0") {
$App.Comp003 = "0";
} else {
};
...
$scope.Headline282_click = function() {$scope.GotoPage( "Home" );};
$scope.Headline283_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("SWITCHES03_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 4;
$App.NAB.PageID = "SWITCHES03";
$scope.Slider9_change = function() {$App.Comp005 = $scope.Calculate($App.switch005+"-"+$App.switch005a,-1);
if ($App.Comp005 <= "0") {
$App.Comp005 = "0";
} else {
};
...
$scope.Headline285_click = function() {$scope.GotoPage( "Home" );};
$scope.Headline226_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("SWITCHES04_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 5;
$App.NAB.PageID = "SWITCHES04";
$scope.Slider13_change = function() {$App.Comp007 = $scope.Calculate($App.switch007+"-"+$App.switch007a,-1);
if ($App.Comp007 <= "0") {
$App.Comp007 = "0";
} else {
};
...
$scope.Headline252_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("SWITCHES05_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 6;
$App.NAB.PageID = "SWITCHES05";
$scope.Slider17_change = function() {$App.Comp009 = $scope.Calculate($App.switch009+"-"+$App.switch009a,-1);
if ($App.Comp009 <= "0") {
$App.Comp009 = "0";
} else {
};
localStorage.setItem("Comp009",$App.Comp009);
$App.Comp009 = localStorage.getItem("Comp009");};
$scope.Slider18_change = function() {$App.Comp009 = $scope.Calculate($App.switch009+"-"+$App.switch009a,-1);
if ($App.Comp009 <= "0") {
$App.Comp009 = "0";
} else {
};
localStorage.setItem("Comp009",$App.Comp009);
$App.Comp009 = localStorage.getItem("Comp009");};
$scope.Slider19_change = function() {$App.Comp010 = $scope.Calculate($App.switch010+"-"+$App.switch010a,-1);
if ($App.Comp010 <= "0") {
$App.Comp010 = "0";
} else {
};
localStorage.setItem("Comp010",$App.Comp010);
$App.Comp010 = localStorage.getItem("Comp010");};
$scope.Slider20_change = function() {$App.Comp010 = $scope.Calculate($App.switch010+"-"+$App.switch010a,-1);
if ($App.Comp010 <= "0") {
$App.Comp010 = "0";
} else {
};
...
$scope.Headline311_click = function() {$scope.GotoPage( "Home" );};
});
