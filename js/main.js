...
$scope.PushButton97_click = function() {$scope.GotoPage( "SWITCHES01" );};
$scope.PushButton98_click = function() {$scope.GotoPage( "SWITCHES01" );};
$scope.PushButton105_click = function() {$scope.GotoPage( "SWITCHES02" );};
$scope.PushButton99_click = function() {$scope.GotoPage( "SWITCHES02" );};
$scope.PushButton106_click = function() {$scope.GotoPage( "SWITCHES02" );};
$scope.PushButton107_click = function() {$scope.GotoPage( "SWITCHES02" );};
$scope.PushButton108_click = function() {$scope.GotoPage( "SWITCHES02" );};
});
